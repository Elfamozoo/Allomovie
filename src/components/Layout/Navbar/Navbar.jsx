			...
			<nav class='bg-amber-300 border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800'>
				<div class='container flex flex-wrap justify-between items-center mx-auto'>
					...
					<div class='flex md:order-2'>
						<button
							type='button'
							class='text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-blue-800'>
							Inscription
						</button>
						<button
